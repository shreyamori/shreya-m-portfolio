      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="relative">
            ...
            <img
              src={profilePhoto}
              alt="Sarah Rodriguez - CS Student"
              className="relative w-full max-w-md mx-auto blob-shape object-cover aspect-square shadow-xl"
            />
            {/* Decorative elements */}
            <div className="absolute top-8 -left-4 w-16 h-16 border-2 border-accent rounded-full animate-float" style={{ animationDelay: "-2s" }} />
            <div className="absolute -bottom-4 right-12 w-8 h-8 bg-forest rounded-full animate-float" />
          </div>

          {/* Content Side */}
          <div>
            <span className="text-accent font-medium tracking-wide text-sm uppercase">About Me</span>
            <h2 className="font-display text-4xl md:text-5xl font-semibold text-primary mt-3 mb-6">
              A curious mind with<br />
              <span className="text-forest-light">a love for craft</span>
            </h2>
            
            <div className="space-y-4 text-muted-foreground leading-relaxed mb-8">
              <p>
                I'm a senior Computer Science student at UC Berkeley with a minor in Design. 
                My journey into tech started with a simple curiosity about how apps are built — 
                and quickly evolved into a passion for creating meaningful digital experiences.
              </p>
              <p>
                When I'm not coding, you'll find me exploring local coffee shops with my camera, 
                tending to my growing collection of houseplants, or getting lost in a good sci-fi novel. 
                I believe the best technology feels invisible and human.
              </p>
              <p>
                Currently seeking internship opportunities where I can contribute to 
                products that make people's lives a little better.
              </p>
            </div>
